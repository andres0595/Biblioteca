<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/master/pagina_maestra.Master"
    AutoEventWireup="true" CodeBehind="aud_rol.aspx.cs" Inherits="Inicial.Vista.administracion.aud_rol" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenidoSistema" runat="server">
    ...
    <span class="ocultar" id="idMenuForm">0.101</span>
    <div class="tbBorde">
        <input type="text" class="ocultar" id="idEscondido" />
        <table class="centrar responsive">
            <tr>
                <td colspan="6" align="center">
                    <span class="tituloForm">AUDITOR&Iacute;A ROLES</span><br />
                    <br />
                    Lista las últimas acciones realizadas con los datos de Roles
                </td>
            </tr>
            <tr>
                <td colspan="6" align="right">
                    <div style="float: right;" id="imgTodos" class="linkIconoSuperior botonTodos" onclick="verTodos(1);">
                        <p>
                            Ver Todos</p>
            ...
            <table class="centrar">
                <tr>
                    <td colspan="2" align="center">
                        <span class="tituloForm">FILTRAR AUDITOR&Iacute;A DE ROLES</span>
                        <br />
                        <br />
                    </td>
                </tr>
                        ...
                        <div>
                            <table class="centrar" width="520px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="txtRol" onkeypress="return letras(event);" class="campoTextoLargo campoMayuscula" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <img src="../../Recursos/imagenes/administracion/listar.png" title="Listar" alt="Listar"
                                            class="imgAdmin" onclick="listaAuditoriaRol(1)" /></div>
                                </td>
                                <td>
                                    <div>
