<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/master/pagina_maestra.Master"
    AutoEventWireup="true" CodeBehind="area.aspx.cs" Inherits="Inicial.Vista.administracion.area" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenidoSistema" runat="server">
    ...
    <script src="../../Recursos/js/ajax/areas.js" type="text/javascript"></script>
    <span class="ocultar" id="idMenuForm">2.4</span>
    <div id="Div1" class="tbBorde">
        <table class="centrar responsive">
            <tr>
                <td colspan="2" align="center">
                    <span class="tituloForm">&Aacute;REAS DE LA EMPRESA</span>
                    <br />
                    <br />
                </td>
            </tr>
            ...
            <tr>
                <td align="center" colspan="2">
                    <div id="divListadoAreas" class="centrar listadoGeneral">
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div style="display: none;">
        <div id="divNuevaArea" style="overflow: hidden;" class="fancyNormal tbBorde">
            <table class="centrar">
                <tr>
                    <td colspan="2" align="center">
                        <span class="tituloForm">CREACI&Oacute;N DE &Aacute;REAS</span>
                        <br />
                        <br />
                    </td>
                </tr>
                        ...
                        <div>
                            <table class="centrar">
                                <tr>
                                    <td>
                                        Departamento: &nbsp;&nbsp;&nbsp;
                                        <select id="seldepartamento" class="select obligatorio">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" id="txtNombreArea" class="campoTextoLargo campoMayuscula obligatorio"
                                ...
                                <td>
                                    <div>
                                        ...
                                        <img src="../../Recursos/imagenes/administracion/guardar.png" title="Guardar" alt="Guardar"
                                            class="imgAdmin" onclick="guardarArea()" /></div>
                                </td>
                                <td>
                                    <div>
            ...
            <table cellpadding="5" class="tbBorde listadoGeneralMedio">
                <tr>
                    <td align="center" class="centrar" colspan="2">
                        <span class="tituloForm">FILTRO DE &Aacute;REAS</span>
                        <br />
                    </td>
                </tr>
                <tr>
    ...
    <div style="display: none">
        <div id="divDetalleArea" style="min-width: 380px;">
            <table class="centrar">
                <tr>
