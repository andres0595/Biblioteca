<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/master/pagina_maestra.Master"
    AutoEventWireup="true" CodeBehind="empresa.aspx.cs" Inherits="Inicial.Vista.administracion.empresa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenidoSistema" runat="server">
    ...
    <script src="../../Recursos/js/ajax/empresas.js" type="text/javascript"></script>
    <script src="../../Recursos/js/ajax/digitoVerificacion.js" type="text/javascript"></script>
    <span class="ocultar" id="idMenuForm">2.7</span>
    ...
    <div class="tbBorde">
        <div class="demo">
            <div id="tabs">
                <ul>
                    <li><a id="pest_general" href="#infoGeneral" onclick="cargaInfoGeneralEmpresa();">General</a></li>
                    <li><a id="pest_economica" href="#infoEconomica" onclick="cargaInfoEconomicaEmpresa();">
                        Econ&oacute;mica</a></li>
                    <li><a id="pest_administrativa" href="#infoAdministrativa" onclick="cargaInfoAdministrativaEmpresa();">
                        Administrativa</a></li>
                    <li><a id="pest_financiera" href="#infoFinanciera" onclick="listarInformacionFactura(1);">
                        Inf. Facturaci&oacute;n</a></li>
                    <li><a id="pest_sedePrincipal" href="#infoSedePrincipal" onclick="cargaInfoSedePpalEmpresa();">
                        Sede Principal</a></li>
                    <li><a id="pest_contacto" href="#infoContacto" onclick="cargaInfoContactoEmpresa();">
                        Contacto</a></li>
                    <li><a id="pest_Administrador" href="#infoAdministrador" onclick="cargaInfoAdministradorEmpresa()">
                        Administrador del Sistema</a></li>
                    <li><a id="pest_logo" href="#infoLogo" onclick="cargaInfoLogoEmpresa()">Logo</a></li>
                </ul>
                <div id="infoGeneral">
                    <input type="text" id="idEscondidoInfoGeneral" class="ocultar" />
                    <table class="centrar responsive">
                        <tr>
                            <td colspan="4" align="center" class="alinearArriba">
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <input type="text" class="campoMayuscula campoTextoLargo ocultar" id="empresa" value="<% Response.Write(Session["nit_empresa"]);%>" />
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="txtNit" onkeypress="return numeros(event);" class="campoTexto obligatorio"
                                    disabled="disabled" onkeyup="calculaDigitoVerificacion(this)" />
                            </td>
                            <td>
                                D&iacute;gito Verificaci&oacute;n
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="selectTipoContribuyente" class="select">
                                </select>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <div id="divPersonaJuridica" runat="server" style="display: none;" clientidmode="Static">
                                    <table>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input type="text" class="campoMayuscula campoTextoLargo" id="txtRazonSocial" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td colspan="3">
                                                <select id="selTipoSociedad" class="selectLargo">
                                                </select>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <td align="center">
                                            <div id="imgGuardar">
                                                ...
                                                <img src="../../Recursos/imagenes/administracion/guardar.png" title="Guardar" alt="Guardar"
                                                    class="imgAdmin" onclick="guardaInfoGeneralEmpresa()" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <div>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <label id="lblActividadPrincipal" class="campoMayuscula msj">
                                                    Nombre de la Actividad Selecciona
                                                </label>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <div>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="txtCodActividadSecundaria" style="width: 24px; display: none;"
                                                    class="campoTextoCorto" />
                                            </td>
                                            <td align="right">
                                                <img width="25px" src="../../Recursos/imagenes/administracion/validar.png" title="Validar"
                                            ...
                                            <td>
                                                <label id="lblActividadSecundaria" class="campoMayuscula msj">
                                                    Nombre de la Actividad Selecciona
                                                </label>
                                            </td>
                                        </tr>
                                ...
                                <div>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="txtCodOtraActividad1" style="width: 24px; display: none;"
                                                    class="campoTextoCorto" />
                                            </td>
                                            <td align="right">
                                                <img width="25px" src="../../Recursos/imagenes/administracion/validar.png" title="Validar"
                                            ...
                                            <td>
                                                <label id="lblOtraActividad1" class="campoMayuscula msj">
                                                    Nombre de la Actividad Selecciona
                                                </label>
                                            </td>
                                        </tr>
                                ...
                                <div>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="txtCodOtraActividad2" style="width: 24px; display: none;"
                                                    class="campoTextoCorto" />
                                            </td>
                                            <td align="right">
                                                <img width="25px" src="../../Recursos/imagenes/administracion/validar.png" title="Validar"
                                            ...
                                            <td>
                                                <label id="lblOtraActividad2" class="campoMayuscula msj">
                                                    Nombre de la Actividad Selecciona
                                                </label>
                                            </td>
                                        </tr>
                ...
                <div id="infoAdministrativa">
                    ...
                    <table class="centrar">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <select id="selectTipoDocumentoRepresentanteLegal" class="select">
                            ...
                            <td>
                                <input type="text" id="txtNumeroDocumentoRepresentante" class="campoTexto" onkeypress="return numeros(event); " />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <select id="selectTipoDocumentoContador" class="select">
                                    <option value="-1">-- SELECCIONE --</option>
                                </select>
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="text" id="txtDocumentoIdContador" class="campoTexto" onkeypress="return numeros(event); " />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <select id="selectTipoDocumentoRevisorFiscal" class="select">
                                    <option value="-1">-- SELECCIONE --</option>
                                </select>
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="text" id="txtDocumentoIdRevisor" class="campoTexto" onkeypress="return numeros(event); " />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <div id="imgGuardar">
                                                <span class="leyenda">Guardar</span><br />
                                                <img src="../../Recursos/imagenes/administracion/guardar.png" title="Guardar" alt="Guardar"
                                                    class="imgAdmin" onclick="guardaInfoAdministrativaEmpresa()" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                ...
                <div id="infoFinanciera">
                    ...
                    <table class="centrar">
                        ...
                        <tr>
                            <td>
                                <div id="imgGuardar" class="linkIconoSuperior botonGuardar ocultar" onclick="nuevoRegistroFacturacion();">
                ...
                <div id="infoSedePrincipal">
                    ...
                    <table class="centrar">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="selPaisSedePrincipal" class="select" onchange="cargaDepartamento(this);">
                                    <option value="-1">-- SELECCIONE --</option>
                                </select>
                            </td>
                            <td>
                            ...
                            <td>
                                <select id="selDeptoSedePrincipal" class="select" onchange="cargaMunicipio(this);">
                                    <option value="-1">-- SELECCIONE --</option>
                                </select>
                            </td>
                            <td>
                            ...
                            <td>
                                <select id="selMuniSedePrincipal" class="select">
                                    <option value="-1">-- SELECCIONE --</option>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="selUbicacionSedePrincipal" class="select">
                                </select>
                            </td>
                            <td>
                                No. Empleados
                                    ...
                                    <tr>
                                        <td align="center">
                                            <div id="imgGuardar">
                                                <span class="leyenda">Guardar</span><br />
                                                <img src="../../Recursos/imagenes/administracion/guardar.png" title="Guardar" alt="Guardar"
                                                    class="imgAdmin" onclick="guardaInfoSedePrincipalEmpresa()" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                ...
                <div id="infoContacto">
                    ...
                    <table class="centrar">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <select id="selCargoContacto" class="select">
                                    <option value="-1">-- SELECCIONE --</option>
                                </select>
                            </td>
                        </tr>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <div id="imgGuardar">
                                                <span class="leyenda">Guardar</span><br />
                                                <img src="../../Recursos/imagenes/administracion/guardar.png" title="Guardar" alt="Guardar"
                                                    class="imgAdmin" onclick="guardaInfoContactoEmpresa()" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <div id="imgGuardar">
                                                <span class="leyenda">Guardar</span><br />
                                                <img src="../../Recursos/imagenes/administracion/guardar.png" title="Guardar" alt="Guardar"
                                                    class="imgAdmin" onclick="guardaInfoAdministradorEmpresa()" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                ...
                <div id="infoLogo">
                    ...
                    <table class="centrar">
                        ...
                        <tr>
                            <td colspan="6" align="center">
                                <iframe id="Iframe1" src="../../Controlador/ctlCargaLogoEmpresa.aspx?reg=0" class="iframeArchivoImagen"
    ...
    <div style="display: none;">
        <div id="divFormularioDetalle" class="tbBorde fancyNormal">
            <table class="centrar">
                <tr>
                    <td colspan="2" align="center">
                        <span class="tituloForm">DETALLE REGISTRO</span>
                        <br />
                        <br />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="right">
                        <div id="divDetalle" class="centrar listadoGeneralDetalle">
                        </div>
                    </td>
                </tr>
                <tr>
    ...
    <!--Ventana con Mensaje para Confirmar Eliminación-->
    <div style="display: none;">
        <div id="confirmaEliminar" class="fancyEliminar">
            <table class="centrar">
                <tr>
                    <td class="encabezado">
                        <span>Mensaje</span>
                ...
                <tr>
                    <td align="center">
                        <table>
                            <tr>
                                <td align="center">
                                    <span>Aceptar</span><br />
                                    <img src="../../Recursos/imagenes/administracion/aceptar.png" onclick="eliminarFacturacion()"
                                        alt="Aceptar" class="imgAdmin" />
                                </td>
                                <td align="center">
                                    <span class="leyenda">Cancelar</span><br />
                                    <img src="../../Recursos/imagenes/administracion/cancelar.png" onclick="cerrarVentanaEmergente()"
