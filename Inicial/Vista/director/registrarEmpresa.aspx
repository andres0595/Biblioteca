<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/master/pagina_maestra.Master"
    AutoEventWireup="true" CodeBehind="registrarEmpresa.aspx.cs" Inherits="Inicial.Vista.director.registrarEmpresa" %>
        ...
        <div class="demo">
            <div id="tabs">
                <ul>
                    ...
                    <li><a id="pest_economica" href="#infoEconomica"> <%--onclick="listarCodigosCIIU('-1', 'selDivision');"--%>
                        Economica</a></li>
                    <li><a id="pest_administrativa" href="#infoAdministrativa" onclick="cargaTipDocumentoTercero();">
                        Administrativa</a></li>
                    <li><a id="pest_financiera" href="#infoFinanciera" onclick="listarInformacionFactura(1);">
                        Inf. Facturaci&oacute;n</a></li>
                    <li><a id="pest_sedePrincipal" href="#infoSedePrincipal" onclick="cargaPais(); cargaUbicacion();">
                        Sede Principal</a></li>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="txtNit" onkeypress="return numeros(event);" class="campoTexto obligatorio"
                                    onkeyup="calculaDigitoVerificacion(this)" />
                            </td>
                            <td>
                                        ...
                                        <td align="center">
                                            <div id="imgGuardar">
                                                ...
                                                <img src="../../Recursos/imagenes/administracion/guardarysiguiente.png" title="Guardar"
                                                    alt="Guardar" class="imgAdmin" onclick="guardaInfoGeneralEmpresa()" /></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                ...
                <div id="infoEconomica">
                    ...
                    <table class="centrar">
                            ...
                            <td colspan="3">
                                <div>
                                    <table>
                                        <tr>
                                            <td>
                                                <input type="text" id="txtActividadPrincipal" class="campoTexto" onkeypress="return numeros(event);" />
                                            </td>
                                            <td align="right">
                                                ...
                                                <img width="25px" src="../../Recursos/imagenes/administracion/buscar.png" title="Buscar"
                                                    alt="Buscar" class="imgAdminPequenia" onclick="buscaActividadEconomica('ACTIVIDAD')" />
                                            </td>
                                            <td>
                            ...
                            <td colspan="3">
                                <div>
                                    <table>
                                        <tr>
                                            <td>
                                                <input type="text" id="txtActividadSecundaria" class="campoTexto" onkeypress="return numeros(event);" />
                                            </td>
                                            <td align="right">
                                                <img width="25px" src="../../Recursos/imagenes/administracion/validar.png" title="Validar"
                                                    alt="Validar" class="imgAdminPequenia" onclick="validaActividadEconomica('SECUNDARIA')" />
                                                <img width="25px" src="../../Recursos/imagenes/administracion/buscar.png" title="Buscar"
                                                    alt="Buscar" class="imgAdminPequenia" onclick="buscaActividadEconomica('SECUNDARIA')" />
                                            </td>
                                            <td>
                            ...
                            <td colspan="3">
                                <div>
                                    <table>
                                        <tr>
                                            <td>
                                                <input type="text" id="txtOtraActividad1" class="campoTexto" onkeypress="return numeros(event);" />
                                            </td>
                                            <td align="right">
                                                <img width="25px" src="../../Recursos/imagenes/administracion/validar.png" title="Validar"
                                                    alt="Validar" class="imgAdminPequenia" onclick="validaActividadEconomica('OTRA ACTIVIDAD 1')" />
                                                <img width="25px" src="../../Recursos/imagenes/administracion/buscar.png" title="Buscar"
                                                    alt="Buscar" class="imgAdminPequenia" onclick="buscaActividadEconomica('OTRA ACTIVIDAD 1')" />
                                            </td>
                                            <td>
                            ...
                            <td colspan="3">
                                <div>
                                    <table>
                                        <tr>
                                            <td>
                                                <input type="text" id="txtOtraActividad2" class="campoTexto" onkeypress="return numeros(event);" />
                                            </td>
                                            <td align="right">
                                                <img width="25px" src="../../Recursos/imagenes/administracion/validar.png" title="Validar"
                                                    alt="Validar" class="imgAdminPequenia" onclick="validaActividadEconomica('OTRA ACTIVIDAD 2')" />
                                                <img width="25px" src="../../Recursos/imagenes/administracion/buscar.png" title="Buscar"
                                                    alt="Buscar" class="imgAdminPequenia" onclick="buscaActividadEconomica('OTRA ACTIVIDAD 2')" />
                                            </td>
                                            <td>
                        ...
                        <%--<tr>
                            ...
                            <td colspan="5">
                                <select id="selDivision" class="selectLargo" onchange="listarCodigosCIIU(this,'selGrupo'); cambiaDivision(this);">
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <select id="selGrupo" class="selectLargo" onchange="listarCodigosCIIU(this,'selClase'); cambiaGrupo(this);">
                                    <option value="-1">-- SELECCIONE --</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="5">
                                <select id="selClase" class=" selectLargo" onchange="listarCodigosCIIU(this,'divCodigosCIIU'); cambiaClase(this);">
                                    <option value="-1">-- SELECCIONE --</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
                                <div id="divCodigosCIIU" class="centrar">
                                </div>
                            </td>
                        </tr>--%>
                        <tr>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <div id="imgGuardar">
                                                <span class="leyenda">Siguiente</span><br />
                                                <img src="../../Recursos/imagenes/administracion/guardarysiguiente.png" title="Guardar"
                                                    alt="Guardar" class="imgAdmin" onclick="guardaInfoEconomicaEmpresa()" /></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <div id="imgGuardar">
                                                <span class="leyenda">Siguiente</span><br />
                                                <img src="../../Recursos/imagenes/administracion/guardarysiguiente.png" title="Guardar"
                                                    alt="Guardar" class="imgAdmin" onclick="guardaInfoAdministrativaEmpresa()" /></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <div id="imgGuardar">
                                                <span class="leyenda">Siguiente</span><br />
                                                <img src="../../Recursos/imagenes/administracion/guardarysiguiente.png" title="Guardar"
                                                    alt="Guardar" class="imgAdmin" onclick="continuarFacturacion()" /></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <div id="imgGuardar">
                                                <span class="leyenda">Siguiente</span><br />
                                                <img src="../../Recursos/imagenes/administracion/guardarysiguiente.png" title="Guardar"
                                                    alt="Guardar" class="imgAdmin" onclick="guardaInfoSedePrincipalEmpresa()" /></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                ...
                <div id="infoContacto">
                    ...
                    <table class="centrar">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="txtEmailContacto" class="campoTexto" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <div id="imgGuardar">
                                                <span class="leyenda">Siguiente</span><br />
                                                <img src="../../Recursos/imagenes/administracion/guardarysiguiente.png" title="Guardar"
                                                    alt="Guardar" class="imgAdmin" onclick="guardaInfoContactoEmpresa()" /></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <div id="imgGuardar">
                                                <span class="leyenda">Siguiente</span><br />
                                                <img src="../../Recursos/imagenes/administracion/guardarysiguiente.png" title="Guardar"
                                                    alt="Guardar" class="imgAdmin" onclick="guardaInfoAdministradorEmpresa()" /></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                        ...
                                        <td align="center">
                                            <div id="imgGuardar">
                                                ...
                                                <img src="../../Recursos/imagenes/administracion/guardar.png" title="Guardar" alt="Guardar"
                                                    class="imgAdmin" onclick="guardaLogoEmpresa()" /></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <tr>
                                <td align="center">
                                    <div id="imgGuardar">
                                        ...
                                        <img src="../../Recursos/imagenes/administracion/guardar.png" title="Guardar" alt="Guardar"
                                            class="imgAdmin" onclick="guardaInfoFinancieraEmpresa()" /></div>
                                </td>
                                <td align="center">
